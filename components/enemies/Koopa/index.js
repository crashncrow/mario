  ...
  <div className='relative w-16 h-16'>
    ...
    {state === 'dead' ? (
      ...
      <>
        ...
        <div className='absolute left-2 top-12 w-3 h-3 bg-smb-yellow'></div>
        <div className='absolute left-11 top-12 w-3 h-3 bg-smb-yellow'></div>
      </>
    ) : (
      <>
        ...
        <div className='absolute left-2 top-10 w-3 h-5 bg-smb-yellow'></div>
        <div className='absolute left-11 top-10 w-3 h-5 bg-smb-yellow'></div>
        ...
        <div className='absolute left-6 top-4 w-4 h-6 bg-smb-yellow'></div>
